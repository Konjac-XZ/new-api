...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/:id/breaker/detail", controller.GetChannelBreakerDetail)
			channelRoute.GET("/:id", controller.GetChannel)
			channelRoute.POST("/:id/key", middleware.RootAuth(), middleware.CriticalRateLimit(), middleware.DisableCache(), middleware.SecureVerificationRequired(), controller.GetChannelKey)
			channelRoute.GET("/test", controller.TestAllChannels)
			channelRoute.GET("/test/:id", controller.TestChannel)
			channelRoute.GET("/test/:id/stream", controller.TestChannelStream)
			...
			channelRoute.POST("/breaker/reset", controller.ResetDynamicChannelBreakers)
			channelRoute.POST("/:id/breaker/reset", controller.ResetDynamicChannelBreaker)

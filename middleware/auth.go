...
// AdminAuthForWebSocket accepts the dashboard access token from the WebSocket
// query string because browsers cannot attach an Authorization header during
// the handshake. The token is validated through the standard dashboard path.

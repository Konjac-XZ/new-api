...
func setupTaskPluginBindChannelTest(t *testing.T) {
	...
	require.NoError(t, database.AutoMigrate(&model.Channel{}, &model.ChannelBreakerState{}, &model.ChannelTestConfig{}, &model.Ability{}, &model.CasbinRule{}, &model.AuthzRole{}, &model.Log{}, &model.AuditLog{}, &model.User{}))
	model.DB = database

...
export const tintedBadgeClassMap = {
  ...
  blue: 'border-chart-1/25 bg-chart-1/10 text-chart-1',
  cyan: 'border-chart-2/25 bg-chart-2/10 text-chart-2',
  danger: 'border-destructive/25 bg-destructive/10 text-destructive',
  destructive: 'border-destructive/25 bg-destructive/10 text-destructive',
  green: 'border-success/25 bg-success/10 text-success',
  grey: 'border-border/60 bg-muted/40 text-muted-foreground',
  indigo: 'border-chart-1/25 bg-chart-1/10 text-chart-1',
  info: 'border-info/25 bg-info/10 text-info',
  'light-blue': 'border-info/25 bg-info/10 text-info',
  'light-green':
    'border-emerald-400/25 bg-emerald-400/10 text-emerald-500 dark:text-emerald-300',
  lime: 'border-chart-3/25 bg-chart-3/10 text-chart-3',
  neutral: 'border-border/60 bg-muted/40 text-muted-foreground',
  orange: 'border-warning/30 bg-warning/10 text-warning',
  pink: 'border-chart-5/25 bg-chart-5/10 text-chart-5',
  purple: 'border-chart-4/25 bg-chart-4/10 text-chart-4',
  red: 'border-destructive/25 bg-destructive/10 text-destructive',
  success: 'border-success/25 bg-success/10 text-success',
  teal: 'border-chart-2/25 bg-chart-2/10 text-chart-2',
  violet: 'border-chart-4/25 bg-chart-4/10 text-chart-4',

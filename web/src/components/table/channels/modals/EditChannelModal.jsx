              ...
              <div className='space-y-4'>
                <div className='pb-3 border-b border-gray-100'>
                  ...
                  <Form.Switch
                    ...
                    extraText={t(
                      '仅在开启自动禁用时生效。根据真实请求的近期失败、连续失败和恢复情况，临时将该渠道移出候选列表；并基于健康度自动动态调整该渠道有效权重（无需额外开关）。',
                    )}
                  />
                  ...
                  <Form.InputNumber
                    ...
                    style={{ width: '100%' }}
                    extraText={t(
                      '动态熔断容错系数，范围 0.1 - 10.0，默认 1.0。值越大允许更多失败次数才触发冷却，并提高健康度上限；值越小则更灵敏。',
                    )}
                  />
                  ...
                  <div className='p-2 space-y-3' ref={formContainerRef}>
                    ...
                    <div ref={(el) => (formSectionRefs.current.basicInfo = el)}>
                      <Card className='!rounded-2xl shadow-sm border-0'>
                        ...
                        {showApiConfigCard && (
                          <div ref={(el) => (formSectionRefs.current.apiConfig = el)} onClick={handleApiConfigSecretClick}>

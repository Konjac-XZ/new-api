...
func GetChannelExclude(group string, model string, exclude map[int]bool, requestPath ...string) (*Channel, error) {
	rp := ""
	...
	for _, p := range priorities {
		...
		abilities = filterAbilitiesByRequestPathAndModel(abilities, rp, model)
